...
import type { ContextProvider_Literal__docs___DocsParameters__Output } from './ContextProvider_Literal__docs___DocsParameters__Output';
...
export type ProjectConfig_Output = {
    /**
     * Project models
     */
     ...
     * Context providers
     */
    contextProviders?: Array<(ContextProvider_Literal__code___NoneType_ | ContextProvider_Literal__codebase___NoneType_ | ContextProvider_Literal__diff___NoneType_ | ContextProvider_Literal__docs___DocsParameters__Output | ContextProvider_Literal__open___OpenParameters_ | ContextProvider_Literal__search___NoneType_ | ContextProvider_Literal__url___NoneType_)>;
    /**
     * Embeddings provider
     */
