...
from ollama_x.client.ollama import OllamaModelDetails, OllamaModelInfo, OllamaModelShowResponse
...
class OllamaModel(Document):
    ...
    details: OllamaModelDetails = Field(description="OllamaModel details")
    info: OllamaModelInfo = Field(description="OllamaModel info")
    ...
    @classmethod
    def from_ollama_show(cls, model_name: str, data: OllamaModelShowResponse, digest: str) -> Self:
        return cls(
            id=model_name,
            file=data.modelfile,
    ...
    async def create_or_update(
        cls, name: str, ollama_show: OllamaModelShowResponse, digest: str
    ) -> Self:
